...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(0, 0, 471, 341))
        ...
        self.toolBox.setGeometry(QtCore.QRect(100, 0, 371, 201))
        self.toolBox.setObjectName("toolBox")
        self.fanmode = QtWidgets.QWidget()
        self.fanmode.setGeometry(QtCore.QRect(0, 0, 371, 90))
        ...
        self.fanModeLabel.setGeometry(QtCore.QRect(10, 30, 361, 23))
        ...
        self.gpiosetup.setGeometry(QtCore.QRect(0, 0, 371, 90))
        ...
        self.fanGPIOLabel.setGeometry(QtCore.QRect(70, 10, 291, 41))
        ...
        self.temperaturethreshold.setGeometry(QtCore.QRect(0, 0, 371, 90))
        ...
        self.tempLabel.setGeometry(QtCore.QRect(60, 10, 301, 41))
        ...
        self.fanControlApply.setGeometry(QtCore.QRect(380, 310, 96, 29))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 290, 291, 52))
        ...
        self.overclocking = QtWidgets.QWidget()
        self.overclocking.setObjectName("overclocking")
        self.overclockingIcon = QtWidgets.QLabel(self.overclocking)
        self.overclockingIcon.setGeometry(QtCore.QRect(0, 0, 101, 101))
        self.overclockingIcon.setObjectName("overclockingIcon")
        self.overclockingLabel = QtWidgets.QLabel(self.overclocking)
        self.overclockingLabel.setGeometry(QtCore.QRect(100, 0, 371, 131))
        self.overclockingLabel.setWordWrap(True)
        self.overclockingLabel.setObjectName("overclockingLabel")
        self.cpuFreqBox = QtWidgets.QSpinBox(self.overclocking)
        self.cpuFreqBox.setGeometry(QtCore.QRect(10, 140, 121, 37))
        self.cpuFreqBox.setPrefix("")
        self.cpuFreqBox.setMinimum(900)
        self.cpuFreqBox.setMaximum(2500)
        self.cpuFreqBox.setObjectName("cpuFreqBox")
        self.overclockingLabel_2 = QtWidgets.QLabel(self.overclocking)
        self.overclockingLabel_2.setGeometry(QtCore.QRect(150, 140, 311, 31))
        self.overclockingLabel_2.setObjectName("overclockingLabel_2")
        self.overvoltBox = QtWidgets.QSpinBox(self.overclocking)
        self.overvoltBox.setGeometry(QtCore.QRect(10, 190, 121, 37))
        self.overvoltBox.setMaximum(6)
        self.overvoltBox.setObjectName("overvoltBox")
        self.overclockingLabel_3 = QtWidgets.QLabel(self.overclocking)
        self.overclockingLabel_3.setGeometry(QtCore.QRect(150, 190, 311, 41))
        self.overclockingLabel_3.setObjectName("overclockingLabel_3")
        self.overclockApply = QtWidgets.QPushButton(self.overclocking)
        self.overclockApply.setGeometry(QtCore.QRect(380, 310, 96, 29))
        self.overclockApply.setObjectName("overclockApply")
        self.tabWidget.addTab(self.overclocking, "")
        self.about = QtWidgets.QWidget()
        self.about.setObjectName("about")
        self.label = QtWidgets.QLabel(self.about)
        self.label.setGeometry(QtCore.QRect(10, 0, 461, 341))
    ...
    def retranslateUi(self, Form):
        ...
        self.fanGPIOLabel.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:10pt;\">GPIO fan pin - default is 19</span></p></body></html>"))
        ...
        self.overclockingIcon.setText(_translate("Form", "<html><head/><body><p><img src=\":/overclocking/assets/overclock.png\"/></p></body></html>"))
        self.overclockingLabel.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:10pt;\">Overclocking is a way to get more performance out of your device without upgrading the hardware. However, there is the possibility of your device crashing or randomly rebooting if you select an unstable overclock. Modify this at your own risk!</span></p></body></html>"))
        self.cpuFreqBox.setSuffix(_translate("Form", " MHz"))
        self.overclockingLabel_2.setText(_translate("Form", "CPU Frequency"))
        self.overvoltBox.setSuffix(_translate("Form", " x0.025v"))
        self.overvoltBox.setPrefix(_translate("Form", "+"))
        self.overclockingLabel_3.setText(_translate("Form", "CPU/GPU Overvolt Level"))
        self.overclockApply.setText(_translate("Form", "Apply"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.overclocking), _translate("Form", "Overclocking"))
        self.label.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt;\">Raspi Control Panel - v0.2.1</span></p><p align=\"center\"><span style=\" font-size:16pt;\">Written by AnonymousHacker1279</span></p><p align=\"center\"><a href=\"https://titan-mk4.dynv6.net\"><span style=\" font-weight:600; text-decoration: underline; color:#000000;\">A basic tool to control specific features on your Raspberry Pi. Designed from the ground up in Python and PyQt5.</span></a></p><p align=\"center\"><a href=\"https://github.com/AnonymousHacker1279\"><span style=\" text-decoration: underline; color:#0000ff;\">GitHub</span></a><a href=\"https://github.com/AnonymousHacker1279\"><span style=\" text-decoration: underline; color:#000000;\">, </span></a><a href=\"https://titan-mk4.dynv6.net\"><span style=\" text-decoration: underline; color:#0000ff;\">My Website</span></a></p></body></html>"))
